...
// NewNormalizeOptionsRef creates a new wrapper struct with underlying reference set to the original C object.
// Returns nil if the provided pointer to C object is nil too.
func NewNormalizeOptionsRef(ref unsafe.Pointer) *NormalizeOptions {
	if ref == nil {
		return nil
	}
	obj := new(NormalizeOptions)
	obj.ref23955150 = (*C.normalize_options_t)(unsafe.Pointer(ref))
	return obj
}
...
// NewAddressParserResponseRef creates a new wrapper struct with underlying reference set to the original C object.
// Returns nil if the provided pointer to C object is nil too.
func NewAddressParserResponseRef(ref unsafe.Pointer) *AddressParserResponse {
	if ref == nil {
		return nil
	}
	obj := new(AddressParserResponse)
	obj.ref50c6200b = (*C.address_parser_response_t)(unsafe.Pointer(ref))
	return obj
}
...
// NewAddressParserOptionsRef creates a new wrapper struct with underlying reference set to the original C object.
// Returns nil if the provided pointer to C object is nil too.
func NewAddressParserOptionsRef(ref unsafe.Pointer) *AddressParserOptions {
	if ref == nil {
		return nil
	}
	obj := new(AddressParserOptions)
	obj.refcd8497af = (*C.address_parser_options_t)(unsafe.Pointer(ref))
	return obj
}
